...
import com.teachub.media.storage.tencent.TencentFileStorage;
import com.teachub.media.storage.tencent.TencentMediaStorage;
...
public class TencentConfig {
    ...
    @Bean
    @ConditionalOnProperty(prefix = "teachub.platform", name = "media", havingValue = "TENCENT")
    ...
    @Bean
    @ConditionalOnProperty(prefix = "teachub.platform", name = "file", havingValue = "TENCENT")
